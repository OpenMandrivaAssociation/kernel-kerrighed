...
for i in i386 sparc64 x86_64; do
	[ ! -f $i.config ] || cp -f $i.config %{build_dir}/linux-%{tar_ver}/arch/$i/defconfig
	[ ! -f $i-smp.config ] || cp -f $i-smp.config %{build_dir}/linux-%{tar_ver}/arch/$i/defconfig-smp
done
popd
...
# kerrighed files
%{_kerneldir}/include/kerrighed
%{_kerneldir}/kdb
%{_kerneldir}/kerrighed
%endif
...
# kerrighed files
%{_up_develdir}/include/kerrighed
%{_up_develdir}/kdb
%{_up_develdir}/kerrighed
%endif
